...
describe("Application", () => {
  it("renders correctly", () => {
    ...
    const nameInputElementByName = screen.getByRole("textbox", {
      name: "Name",
    });
    ...
    const termsElementsByLabeText = screen.getByLabelText(
    ...
    const fullNamePlaceholder = screen.getByPlaceholderText("fullnam", {
      exact: false,
    });
    expect(fullNamePlaceholder).toBeInTheDocument();

    const warningAboutFields = screen.getByText(/all fields are mandatory/i, {
      selector: "p",
    });
    ...
    const getCustomHtmlElementByDataTestId =
